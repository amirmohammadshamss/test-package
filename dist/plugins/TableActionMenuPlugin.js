...
function TableActionMenu({ onClose, tableCellNode: _tableCellNode, setIsMenuOpen, contextRef, }) {
    ...
    return (0, react_dom_1.createPortal)(React.createElement("div", { className: "dropdown", ref: dropDownRef, onClick: (e) => {
            e.stopPropagation();
        } },
...
function TableActionMenuPlugin() {
    return (0, react_dom_1.createPortal)(React.createElement(TableCellActionMenuContainer, null), document.body);
}
exports.default = TableActionMenuPlugin;
//# sourceMappingURL=TableActionMenuPlugin.js.map