...
function ImageResizer({ onResizeStart, onResizeEnd, imageRef, maxWidth, editor, showCaption, setShowCaption, }) {
    ...
    return (React.createElement("div", { ref: controlWrapperRef },
        !showCaption && (React.createElement("button", { className: "image-caption-button", ref: buttonRef, onClick: () => {
